...
#include "../../SourceFiles/Controller/mythread.h"
...
QT_MOC_LITERAL(4, 20, 9) // "comRecive"

    },
    "MyThread\0request\0\0s\0comRecive"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::comRecive)) {
                *result = 1;
                return;
            }
        }
